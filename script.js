...
document.getElementById("show-login").onclick=()=>{auth.classList.add("hidden");loginForm.classList.remove("hidden");};
document.getElementById("show-signup").onclick=()=>{auth.classList.add("hidden");signupForm.classList.remove("hidden");};
